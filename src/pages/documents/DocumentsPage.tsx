...
export const DocumentsPage: React.FC = () => {
  ...
  const handleSign = (id: number) => {
    ...
    // Update the selected document to reflect change immediately if needed, 
    // but typically closing the modal is enough or we rely on the main list.
  };
                        ...
                        <Badge
                          variant={
                            doc.status === 'Signed' ? 'success' :
                              doc.status === 'In Review' ? 'warning' : 'secondary'
                          }
                          size="sm"
                        >
                          {doc.status}
