    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link to="/calendar" className="block">
          <Card className="bg-accent-50 border border-accent-100 h-full transition-transform hover:scale-105">
            <CardBody>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-accent-900">{initialEvents.length}</h3>
                </div>
              </div>
            </CardBody>
          </Card>
