    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 animate-fade-in">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {showTwoFactor ? 'Two-Factor Authentication' : 'Sign in to Business Nexus'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {showTwoFactor ? 'Enter the code sent to your device' : 'Connect with investors and entrepreneurs'}
        </p>
      </div>
          ...
          {!showTwoFactor ? (
            ...
            <form className="space-y-6" onSubmit={handleTwoFactorSubmit}>
              ...
              <button
                ...
                className="w-full text-center text-sm text-primary-600 hover:text-primary-500 mt-4"
              >
                Back to Login
              </button>
            </form>
